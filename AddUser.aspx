<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="UserManagementApp.Registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5 mb-4" id="exampleModalLabel">Add User</h1>
...
<%--                        <asp:ListItem>Select Division</asp:ListItem>--%>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <asp:Label ID="LabelHierarchy" runat="server" Text="HierarchySelection" AssociatedControlID="ddlHierarchy"></asp:Label>

                    <asp:DropDownList ID="ddlHierarchy" runat="server" class="form-select">
